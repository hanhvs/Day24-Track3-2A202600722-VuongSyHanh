...
class DenseSearch:
    def __init__(self):
        ...
        # https=False: shared Qdrant on 6333 expects an api-key header (here empty) over plain HTTP;
        # a non-empty api_key would otherwise make the client default to TLS.
